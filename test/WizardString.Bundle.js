...
describe('WizardString.Bundle', () => {
   describe('addSource', () => {
      it('should return this', () => {
         const b = new WizardString.Bundle()
         const source = new WizardString('abcdefghijkl')

         assert.strictEqual(b.addSource({ content: source }), b)
      })

      it('should accept WizardString instance as a single argument', () => {
         const b = new WizardString.Bundle()
         const array = []
         const source = new WizardString('abcdefghijkl', {
            filename: 'foo.js',
      ...
      it('should accept ignore-list hint', () => {
         const b = new WizardString.Bundle()
         const foo = new WizardString('foo', { filename: 'foo.js' })
         const bar = new WizardString('bar', { filename: 'bar.js' })
      ...
      it('respects WizardString init options with { content: source }', () => {
         const b = new WizardString.Bundle()
         const array = []
         const source = new WizardString('abcdefghijkl', {
            filename: 'foo.js',
   ...
   describe('append', () => {
      it('should append content', () => {
         ...
         b.addSource({ content: new WizardString('*') })
      ...
      it('should append content before subsequent sources', () => {
         ...
         b.addSource(new WizardString('*'))

         b.append('123').addSource(new WizardString('-')).append('456')
   ...
   describe('clone', () => {
      it('should clone a bundle', () => {
         const s1 = new WizardString('abcdef')
         const s2 = new WizardString('ghijkl')
         const b = new WizardString.Bundle()
   ...
   describe('generateMap', () => {
      it('should generate a sourcemap', () => {
         const b = new WizardString.Bundle()
            .addSource({
               filename: 'foo.js',
               content: new WizardString('var answer = 42;'),
            })
            .addSource({
               filename: 'bar.js',
               content: new WizardString('console.log( answer );'),
            })
      ...
      it('should handle repeated sources', () => {
         ...
         const foo = new WizardString('var one = 1;\nvar three = 3;', {
            filename: 'foo.js',
         })

         const bar = new WizardString('var two = 2;\nvar four = 4;', {
            filename: 'bar.js',
         })
      ...
      it('should recover original names', () => {
         ...
         const one = new WizardString('function one () {}', { filename: 'one.js' })
         const two = new WizardString('function two () {}', { filename: 'two.js' })
      ...
      it('should exclude sources without filename from sourcemap', () => {
         ...
         const one = new WizardString('function one () {}', { filename: 'one.js' })
         const two = new WizardString('function two () {}', { filename: null })
         const three = new WizardString('function three () {}', { filename: 'three.js' })
      ...
      it('should generate x_google_ignoreList correctly', () => {
         ...
         const two = new WizardString('function two () {}', { filename: 'two.js' })
         const three = new WizardString('function three () {}', { filename: 'three.js' })
         const four = new WizardString('function four () {}', { filename: 'four.js' })
      ...
      it('should handle empty separator', () => {
         ...
         b.addSource({
            content: new WizardString('if ( foo ) { '),
         })

         const s = new WizardString('console.log( 42 );')
...
var template = (function () {
   ...
   describe('indent', () => {
      it('should indent a bundle', () => {
         ...
         b.addSource({ content: new WizardString('abcdef') })
         b.addSource({ content: new WizardString('ghijkl') })
      ...
      it('should ignore non-indented sources when guessing indentation', () => {
         ...
         b.addSource({ content: new WizardString('abcdef') })
         b.addSource({ content: new WizardString('ghijkl') })
         b.addSource({ content: new WizardString('  mnopqr') })
      ...
      it('does not indent sources with no preceding newline, i.e. append()', () => {
         ...
         b.addSource(new WizardString('abcdef'))
         b.addSource(new WizardString('ghijkl'))
      ...
      it('indents content immediately following intro with trailing newline', () => {
         const b = new WizardString.Bundle({ separator: '\n\n' })

         const s = new WizardString('2')
   ...
   describe('trim', () => {
      it('should trim bundle', () => {
         ...
         b.addSource({
            content: new WizardString('   abcdef   '),
         })

         b.addSource({
            content: new WizardString('   ghijkl   '),
         })
   ...
   describe('toString', () => {
      it('should separate with a newline by default', () => {
         ...
         b.addSource(new WizardString('abc'))
         b.addSource(new WizardString('def'))
   ...
   describe('mappings', () => {
      it('should produce correct mappings after remove and move in multiple sources', () => {
         const s1 = 'ABCDE'
         const ms1 = new WizardString(s1, { filename: 'first' })

         const s2 = 'VWXYZ'
         const ms2 = new WizardString(s2, { filename: 'second' })

         const bundle = new WizardString.Bundle()
